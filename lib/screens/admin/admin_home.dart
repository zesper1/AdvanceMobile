// screens/admin/admin_dashboard.dart - FIXED VERSION (no notifications)
...
class _AdminDashboardState extends ConsumerState<AdminDashboard> {
  ...
  void _approveShop(SellerShop shop) {
    // TODO: Add backend logic for approving a shop (e.g., calling your service)
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              // TODO: Add backend logic for rejecting a shop
  ...
  Widget build(BuildContext context) {
    final asyncShops = ref.watch(sellerShopProvider);

    return asyncShops.when(
      data: (allShops) {
        final pendingShops = allShops
